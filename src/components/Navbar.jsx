...
// NOTE: use react-router-dom for Link/NavLink in normal CRA / Vite apps
...
const Header = () => {
  ...
  return (
    <header className="w-full fixed top-0 left-0 z-50 border-b  bg-linear-to-r from-[#010b1a] to-[#001836]  shadow-lg backdrop-blur-md  border-gray-800 ">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center gap-6 p-4 justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 m-auto">
            <button
      ...
      {mobileOpen && (
        <div className="md:hidden bg-linear-to-r from-[#010b1a] to-[#001836] text-gray-200 border-t border-gray-800">
          {/* SERVICES */}
          ...
          {/* ... rest of mobile accordion (industries, resources, company) */}
          {/* For brevity: these follow the same pattern — each Link calls closeAll */}
