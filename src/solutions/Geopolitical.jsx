          ...
          <section id="problems" className="mt-10 grid md:grid-cols-3 gap-6">
            ...
            <aside className="bg-white/6 rounded-2xl p-6">
              ...
              <div className="mt-3 text-slate-200 text-sm">
                <div><strong>Email:</strong> <a className="underline" href="mailto:sales@mociber.com">info@mociber.com</a></div>
                                                <div><strong>Contact:</strong> <a className="underline" href="tel:+(91) 9811257526">+(91) 9811257526</a></div>
