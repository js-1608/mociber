    ...
    return (
        <>
            <HeroBanner
                ...
                heading={<>Vulnerability Management & Testing</>}
                subtext=""
                primaryCta=""
                secondaryCta=""
            />
            ...
            <div className="min-h-screen text-white bg-linear-to-b from-[#000A1F] to-[#0c1b34]">
                <div className="max-w-7xl mx-auto px-1 lg:px-6 py-12">
                    ...
                    <section className="grid md:grid-cols-2 gap-8 items-center bg-white/3 rounded-2xl p-6  shadow-lg">
                        <div>
                            <h1 className="text-3xl md:text-3xl font-bold">Continuous, Risk-Based Vulnerability Reduction for Modern Digital Enterprises</h1>
                            <p className="mt-4 text-slate-200">
                                In today’s rapidly evolving digital landscape—spanning cloud, containers, SaaS, APIs, DevOps pipelines, and software supply chains—vulnerabilities emerge faster than traditional security programs can handle. Periodic scans and reactive patching are no longer enough. What organizations need is continuous, exposure-driven vulnerability management tightly aligned with real-world exploitability and business impact.</p>
                            <p className="mt-4 text-slate-200">
                                Mociber delivers a modern Vulnerability Management & Testing program that prioritizes what attackers can actually exploit, automates remediation, and continuously validates security posture across infrastructure, applications, cloud, and software supply chains.</p>
                            <p className="mt-4 text-slate-200">
                                Our approach reduces attack surface, shortens remediation cycles, and improves cyber resilience in measurable terms.
                            </p>
