...
import { LockKeyhole, Code, Siren } from "lucide-react";
...
export default function ESG() {
  const faqs = [
    ...
    {
      question:
        "How does Mociber help with carbon accounting and climate risk?",
      answer:
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-7xl m-auto mt-8">
            <div className=" rounded-2xl py-16 p-4">
              ...
              <p className="mt-2 text-slate-300">
                Sustainability is no longer optional—it is a global business
                mandate. With rising regulatory expectations, investor scrutiny,
                climate risk, and the shift toward responsible operations,
                organizations must build ESG programs that are transparent,
                measurable, and integrated into core governance.
              </p>
              <h4 className="font-semibold text-blue-500">
                Mociber’s ESG Advisory empowers enterprises to accelerate
                sustainability transformation using data intelligence,
                automation, governance frameworks, and climate-focused
                insights—ensuring resilience, compliance, and long-term value
                creation.
              </h4>
            ...
            <div className=" w-full rounded-2xl overflow-hidden  m-auto ">
              <img
                src="/Services_Images/ESG Advisory.jpeg"
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-18 items-center">
              ...
              <div className="flex justify-center">
                <img
                src="/Services_Images/ESG Advisory 2.jpeg"
              ...
              <div>
                ...
                <p className="text-base text-center font-semibold text-white mt-8">
                  Mociber addresses these challenges with structured ESG
                  frameworks, automated data intelligence, and globally aligned
                  methodologies.
                </p>
              </div>
            </div>
        ...
        <ServiceSolution
          solutions={solutions}
          heading={"Mociber’s ESG Advisory Services"}
        />
