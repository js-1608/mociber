...
export default function OtIot() {
  const faqs = [
    ...
    {
      question:
        "How does Mociber secure critical infrastructure and industrial systems?",
      answer:
    ...
    {
      question:
        "Does Mociber support compliance like IEC 62443 and NIST 800-82?",
      answer:
    ...
    {
      question:
        "Can Mociber protect IoT devices against botnets and ransomware?",
      answer:
    ...
    {
      question:
        "How can organizations start their OT/IoT security program with Mociber?",
      answer:
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-7xl m-auto ">
            <div className=" rounded-2xl py-16 p-4">
              ...
              <h4 className="font-semibold text-blue-500">
                Protecting Critical Infrastructure, Industrial Systems &
                Intelligent Devices with AI-Driven Cyber Defense
              </h4>
              <p className="mt-2 text-slate-300">
                Operational Technology (OT), Internet of Things (IoT), and Edge
                Computing now power manufacturing lines, medical devices, energy
                grids, logistics networks, and smart cities. While this
                hyper-connected ecosystem accelerates efficiency, it also
                creates one of the largest and fastest-growing attack surfaces
                across modern enterprises.{" "}
              </p>
              <p className="mt-2 text-slate-300">
                Threat actors—including ransomware groups, cybercriminal
                syndicates, and nation-state adversaries—aggressively target
                these environments because they lack standardization, run on
                legacy systems, and cannot tolerate downtime.
              </p>
              <h4 className="font-semibold text-blue-500">
                Mociber secures mission-critical OT, IoT, and Edge environments
                with intelligence-led defense, a visibility-first architecture,
                Zero Trust segmentation, and 24/7 monitoring, all designed
                specifically for high-availability ecosystems.{" "}
              </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-18 items-center">
              ...
              <div>
                ...
                <p className="text-base text-center font-semibold text-white mt-8">
                  Organizations need a unified cybersecurity model that
                  understands both the physical and digital layers of industrial
                  environments.
                </p>
              </div>
            </div>
        ...
        <ServiceSolution
          solutions={solutions}
          heading={"Mociber’s OT, IoT & Edge Security Solutions"}
        />
