                ...
                <motion.section id="intro" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="bg-linear-to-b from-[#000A1F] to-[#0c1b34]">
                    <div className="grid md:grid-cols-2 gap-8 items-center max-w-7xl m-auto ">
                        <div className=" rounded-2xl py-16 p-4">
                            <h2 className="text-2xl md:text-3xl font-bold mt-6 mb-2">Compliance & Auditing Services</h2>
                            <h4 className="font-semibold text-blue-500">Strengthen Governance. Build Trust. Achieve Regulatory Excellence</h4>
                            <p className="mt-2 text-slate-300">
                                In today’s world of rapidly shifting regulations, rising cyber threats, and complex digital ecosystems, organizations must demonstrate compliance—not just claim it. Traditional, manual audit processes can no longer keep pace with global standards or regulatory expectations.
                            </p>
                            <h4 className="font-semibold text-blue-500">
                                Mociber helps enterprises establish a modern, automated, risk-driven compliance framework that ensures continuous governance, audit readiness, and regulatory alignment across all functions.
                            </h4>
                            <p className="mt-2 text-slate-300">
                                We blend regulatory intelligence, AI-powered automation, and deep domain expertise to create a compliance posture that is sustainable, defensible, and future-ready.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-18 items-center">
                            ...
                            <div>
                                ...
                                <p className="text-base text-center font-semibold text-white mt-8">
                                    Mociber solves these challenges with automation-first, intelligence-driven compliance programs.
                                </p>
                            </div>
                        </div>
                    </motion.div>
